...
const mods = [
  ...
  ["3253385114", "'81 DeLorean DMC-12", "Adiciona o DeLorean comum e, naturalmente, uma variante inspirada em máquina do tempo.", "vehicles"],
  ...
  ["3058279917", "Game Night", "Permite jogar cartas e jogos de tabuleiro. Até o apocalipse merece uma noite de jogos.", "content"],
  ...
  ["2544353492", "Has Been Read", "Marca livros e mídias como não lidos, parciais ou concluídos, evitando releitura acidental.", "interface"],
  ["3496924086", "Home Inventory", "Ajuda a consultar o que já está nos recipientes da base sem abrir armário por armário.", "interface"],
  ...
  ["2769706949", "Tidy Up Meister", "Devolve ferramentas e recipientes ao lugar depois de várias ações. Sua mãe ficaria orgulhosa.", "interface"],
  ...
  ["3739168410", "Obvious Skill Tapes", "Destaca em verde as fitas VHS que ensinam skills ou receitas. A locadora agradece.", "interface"],
  ["3783399153", "Peachey's Biofuel", "Permite produzir etanol de milho e refiná-lo como combustível.", "gameplay"],
  ["3638469608", "Read Faster When Sitting", "Reduz o tempo de leitura quando o personagem está sentado, porque conforto ainda conta.", "gameplay"],
  ...
  ["3775841600", "Ladders?!", "Permite subir e descer escadas verticais. Sim, a escada finalmente funciona como escada.", "gameplay"],
